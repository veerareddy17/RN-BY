                                ...
                                >
                                    ...
                                    >
                                        <Text
                                            style={{
                                                marginLeft: 30,
                                                color: this.props.statuses[index] == 'visible' ? 'black' : '#813588',
                                            }}
                                        >
                                            {item.name}
                                        </Text>
                                        {this.props.statuses[index] == 'visible' ? (
                                            <Text></Text>
                                        ) : (
                                            <Text style={{ marginRight: 10, color: '#813588' }}>yes</Text>
                                        )}
                                    </View>
                                </TouchableOpacity>
                            </View>
            ...
            <View style={{ flex: 1 }}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                    <TouchableOpacity onPress={this._onPressClose}>
                        ...
                        >
                            <Icon style={{ marginRight: 10, color: '#fff' }} name="close" />
                        </View>
                    </TouchableOpacity>
                ...
                <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                    <Text style={{ textAlignVertical: 'center', textAlign: 'center' }}>{this.props.description}</Text>
