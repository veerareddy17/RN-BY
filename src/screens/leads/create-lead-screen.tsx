                    ...
                    setFieldValue,
                        ...
                        <Container>
                                                ...
                                                <Body>
                                                    <View style={{ flexDirection: 'row', flex: 1 }}>
                                                        <View style={{ flex: 1 }}>
                                                            ...
                                                            ) : this.state.showOTPMsg && this.props.otpState.validated ? (
                            ...
                            <Footer>
                                <FooterTab>
                                    <Button
                                        disabled={isValid && this.state.proceedWithoutOtp ? false
                                            : isValid && !this.state.proceedWithoutOtp && this.props.otpState.validated ? false : true}
                                        full={true}
                                        onPress={handleSubmit}
                                        style={{
                                            backgroundColor: isValid && this.state.proceedWithoutOtp ? '#813588'
                                                : isValid && !this.state.proceedWithoutOtp && this.props.otpState.validated ? '#813588' : '#ccc'
                                        }}
                                    >
