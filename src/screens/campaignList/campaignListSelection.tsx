...
import { Text, View, Spinner, Content, Header, Container, Left, Button, Title, Right, Body, Footer, FooterTab, Icon, List, ListItem } from 'native-base';
              ...
              <View>
                <List>
                  {this.props.campaignState.campaignList.map(campaign => {
                    return <ListItem><Left><Text>{campaign.name}</Text></Left><Right><Icon name="arrow-forward" onPress={() => this.handleSelections(campaign)} /></Right></ListItem>;
                  })}
                </List>
              </View>
            )}
